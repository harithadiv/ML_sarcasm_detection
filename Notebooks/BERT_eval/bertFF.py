# Following tutorial from https://skimai.com/fine-tuning-bert-for-sentiment-analysis/
import os
import re
...
# Evaluate the Bert classifier
print('Evaluating model with threshold of 0.9...')
evaluate_roc(probs, y_test, threshold)

print('Evaluating model with threshold of 0.5...')
evaluate_roc(probs, y_test, 0.5)