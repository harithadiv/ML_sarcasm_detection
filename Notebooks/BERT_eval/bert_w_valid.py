...
train, valid, test = TabularDataset.splits(path=os.getcwd(), train='sarcasm_train.csv', validation='sarcasm_valid.csv', test='sarcasm_test.csv', format='CSV', fields=fields, skip_header=True)
# Iterators
